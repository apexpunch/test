...
public class Starter {
    ...
    private void startClientInteraction() throws IOException {
        System.out.println("Hello, my dear user. Your name?");
        ...
        while (!operation.equalsIgnoreCase("exit")){
            switch (operation.toLowerCase()){
                case "add" :
                    ...
                    if (nominal !=null){
                        ...
                        System.out.println("Success adding money");
                    }
                    else {
                        System.out.println("WTF? CHEATER!");
                    }
                    break;
                case "get" :
                    break;
            ...
            System.out.println("What's your command? (add, get, exit)");
